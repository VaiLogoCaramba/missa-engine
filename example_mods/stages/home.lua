...
scrollA2()
    ...
    makeAnimatedLuaSprite('tori', 'stage/Tori', 40, -100);
    setLuaSpriteScrollFactor('tori', 1, 1);
    scaleObject('tori', 10, 10);
    setProperty('tori.antialiasing',false);

    addLuaSprite('tori', false);
    addAnimationByPrefix('tori', 'tori', 'Tori Idle',6, true)
