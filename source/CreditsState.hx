...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Roberto',			'roberto',			'Coding(album, freeplay), ola mama',	'https://twitter.com/RobertoTheCoder',	'29FF00'],
			...
			['Dan',				'Dan',			'Compositor de otamatone',						'https://twitter.com/IDannnnK',			'CF2D2D'],
