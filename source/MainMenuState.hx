...
{
	public static var psychEngineVersion:String = '0.6.4'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var bg = new Character(250,-400, 'BG', true);
		...
		char1 = new Character(620,-400, 'cuadros', true);
        char1.setGraphicSize (Std.int(char1.width * 0.8 ));
		add(char1);
		char1.visible = false;

		char2 = new Character(630,100, 'KirbyARMA', true);
		...
		char5 = new Character(660,50, 'LogoOptions', true);
        char5.setGraphicSize (Std.int(char5.width * 0.7 ));
		add(char5);
		char5.visible = false;

		char6 = new Character(650,0, 'LogoStoryMode', true);
		...
		add(disco);
		//van a la linea 229 y ponen para que se reprodusca la animacion
	...
	override function update(elapsed:Float)
	{
		...
		disco.animation.play('DiscoIdle');
		...
		if (FlxG.mouse.overlaps(disco) && FlxG.mouse.justPressed) {
	...
	if (optionShit[curSelected] ==  'story_mode')
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				if (optionShit[curSelected] == 'donate')
				{
					CoolUtil.browserLoad('https://www.youtube.com/c/MissaSinfonia');
				}
				else
				{
					selectedSomethin = true;
