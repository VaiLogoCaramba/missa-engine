...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['No mames..', 0.2], //From 0% to 19%
		['Horrible', 0.4], //From 20% to 39%
		['Malo', 0.5], //From 40% to 49%
		['Wey..', 0.6], //From 50% to 59%
		['Pues..', 0.69], //From 60% to 68%
		['Rico', 0.7], //69%
		['Nada mal', 0.8], //From 70% to 79%
		['Chido', 0.9], //From 80% to 89%
		['Chingon!', 1], //From 90% to 99%
		['ALV WEY!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
