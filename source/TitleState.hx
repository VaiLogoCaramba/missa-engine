	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['VS Missa por'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Charmipotato', 15);
					addMoreText('JaparoProductions', 15);
					addMoreText('VS Missa TEAM', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['Este mod', 'Es para'], -40);
					#else
					createCoolText(['este mod', 'es para'], -40);
					#end
				case 8:
					addMoreText('este tipo', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Symphony'); // credTextShit.text += '\nFunkin';
